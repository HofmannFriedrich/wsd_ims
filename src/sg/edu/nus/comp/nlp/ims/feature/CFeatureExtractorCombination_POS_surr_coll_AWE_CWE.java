 ...
 *
 */
public class CFeatureExtractorCombination_POS_surr_coll_AWE_CWE implements IFeatureExtractor {
	 ...
	 * constructor
	 */
	public CFeatureExtractorCombination_POS_surr_coll_AWE_CWE() {
		...
		this.m_FeatureExtractors.add(new CAWEFeatureExtractor());
		this.m_FeatureExtractors.add(new CCWEFeatureExtractor());
	}
