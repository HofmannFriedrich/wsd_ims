 ...
 *
 */
public class CFeatureExtractorCombination_POS_surr_coll_brown_clark_w2v implements IFeatureExtractor {
	 ...
	 * constructor
	 */
	public CFeatureExtractorCombination_POS_surr_coll_brown_clark_w2v() {
		...
		this.m_FeatureExtractors.add(new CBrownClusterFeatureExtractor());
		this.m_FeatureExtractors.add(new CClarkClusterFeatureExtractor());
		this.m_FeatureExtractors.add(new CW2VClusterFeatureExtractor());
